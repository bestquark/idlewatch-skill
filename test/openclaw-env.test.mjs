...
test('quickstart and configure keep one-off runs honest about background install under npm exec env', () => {
  ...
  try {
    ...
    assert.match(quickstart.stdout, /Install IdleWatch once, then run idlewatch install-agent/)
    ...
    assert.match(configure.stdout, /Install IdleWatch once, then run idlewatch install-agent/)
