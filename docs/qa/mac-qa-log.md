...
## Status: OPEN — small polish issue logged
...
**Acceptance criteria:**
- [ ] After `configure`, the saved env file does not incorrectly claim it was generated by `quickstart`.
- [ ] The header copy remains accurate whether the latest save came from quickstart or configure.
- [ ] Metric toggle persistence behavior remains unchanged.
- [ ] Device identity persistence behavior remains unchanged.
